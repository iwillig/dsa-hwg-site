...
const AboutInfo  = (props) => {
  return (
    <div>
      ...
      <p>
        This year, our campaign to <a href="https://docs.google.com/document/d/1LI8yFmB_BWXDsrV_YXLu-iuYq_UMsXeM3C8m6vzhF5w/edit">Win Long Term Care and Build Power for the New York Health Act</a> is one of NYC-DSA’s five priority campaigns. Learn more about this campaign <a href="https://docs.google.com/document/d/1LI8yFmB_BWXDsrV_YXLu-iuYq_UMsXeM3C8m6vzhF5w/edit">here</a>. To learn more about our working group’s structure and how we function, check out our <a href="https://docs.google.com/document/d/1Ob4mIwyKz38GhqYoGIW6PsxqsxDMHaQhOJiucvpptdw/edit">internal organization document</a>. You can reach us by email at <a href="mailto:healthcare@socialists.nyc">healthcare@socialists.nyc</a> or <a href="https://join.slack.com/t/nyc-dsa-healthcare/shared_invite/zt-qyf20db9-HFU2a8CJWmS8YgcIW5tQpg">join our slack</a> to stay up-to-date on what we’re up to.
      </p>
    </div>
  );
};
